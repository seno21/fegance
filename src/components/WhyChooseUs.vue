    ...
    <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div v-if="loading" class="space-y-10">
        <div class="flex flex-col items-center space-y-4">
          <div class="h-4 w-40 bg-line rounded animate-pulse" />
          <div class="h-10 w-72 bg-line rounded animate-pulse" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="n in 3" :key="n" class="bg-white border border-[#ECECEC] rounded-[24px] p-12 space-y-6">
            ...
            <div class="space-y-2">
              ...
              <div class="h-4 w-3/4 bg-line rounded animate-pulse mx-auto" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div v-else>
        <!-- Header -->
        <div
          class="text-center max-w-2xl mx-auto mb-14 flex flex-col items-center"
          data-aos="fade-up"
        ...
        >
          ...
          >
            ...
            <h3 class="font-display text-[32px] font-bold text-[#111111] mb-4">
              {{ pillar.title }}
            </h3>
            <p class="font-sans text-[17px] leading-[1.8] text-[#666666]">
              {{ pillar.description }}
            </p>
          </div>
        </div>
