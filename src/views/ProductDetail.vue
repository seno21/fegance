...
type Tab = "description" | "notes" | "ingredients";
          ...
          <div data-aos="fade-left" data-aos-duration="800">
            ...
            <div class="mt-9 flex flex-col sm:flex-row gap-2.5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="btn-brand btn-tiktok flex-1 inline-flex items-center justify-center gap-2.5 px-5 py-3.5 text-[11px] font-semibold tracking-[0.16em] uppercase rounded-pill transition-all duration-200"
              >
            ...
            <div class="py-8 min-h-[180px]">
              ...
              <div
                ...
                class="space-y-3 text-sm text-ink-soft leading-relaxed max-w-prose"
              >
                <p>
                  Alcohol Denat., Parfum (Fragrance), Aqua (Water), Limonene,
                  Linalool, Coumarin, Citronellol, Geraniol, Citral, Eugenol,
                  Benzyl Salicylate.
                </p>
                <p class="text-xs text-faint">
                  *Ingredients may vary slightly between batches. Always check
                  the bottle for the most current ingredient list.
                </p>
              </div>
            </div>
          </div>
