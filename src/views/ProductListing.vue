              ...
              <div class="mt-4 pt-4 border-t border-line/60 flex flex-col gap-1.5" @click.stop>
                ...
                <div class="flex flex-wrap gap-1.5">
                  <a
                    ...
                    class="inline-flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-semibold tracking-wider uppercase rounded-pill border transition-all duration-200"
                    :class="[
                      'border-[#EE4D2D] text-[#EE4D2D] hover:bg-[#EE4D2D] hover:text-white',
                    ]"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="inline-flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-semibold tracking-wider uppercase rounded-pill border transition-all duration-200 border-[#010101] text-[#010101] hover:bg-[#010101] hover:text-white"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="inline-flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-semibold tracking-wider uppercase rounded-pill border transition-all duration-200 border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white"
                  >
                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
