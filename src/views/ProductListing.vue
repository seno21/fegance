              ...
              <div class="mt-4 pt-4 border-t border-line/60 flex flex-col gap-1.5" @click.stop>
                ...
                <div class="flex flex-col sm:flex-row gap-1.5 w-full">
                  <a
                    ...
                    class="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-[10px] font-semibold tracking-wider uppercase rounded-pill border transition-all duration-200 border-[#EE4D2D] text-[#EE4D2D] hover:bg-[#EE4D2D] hover:!text-white group"
                  >
                    <img :src="logoShopee" alt="Shopee" class="w-3.5 h-3.5 object-contain shrink-0 filter group-hover:brightness-0 group-hover:invert transition-all duration-200" />
                    Shopee
                  </a>
                  <a
