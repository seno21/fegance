  ...
  <div>
    ...
    <main class="pt-6 lg:pt-10 pb-20 lg:pb-28">
      ...
      <div class="bg-cream border-b border-line">
        <div
          class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20 text-center"
        >
          <p class="eyebrow mb-3" data-aos="fade-up" data-aos-duration="600">
            Our Collection
          </p>
          <h1
            class="h-display text-4xl sm:text-5xl lg:text-6xl text-ink"
            data-aos="fade-up"
            data-aos-delay="100"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Filter bar -->
        <div
          class="py-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-line"
        >
          ...
          >
            ...
            <span class="text-faint"
              >({{ activeFilter === "all" ? "All" : activeFilter }})</span
            >
          </button>
          ...
          <div class="flex items-center gap-2">
            <label
              for="sort"
              class="text-[12px] font-medium text-faint tracking-wide uppercase shrink-0"
              >Sort</label
            >
            <div class="relative">
              <select
        ...
        >
          ...
          >
            ...
            <div class="p-4 sm:p-5 flex flex-col flex-1">
              ...
              <p
                class="mt-1.5 text-xs sm:text-sm text-muted line-clamp-2 leading-relaxed flex-1"
              >
