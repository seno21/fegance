  ...
  <footer class="bg-black border-t border-amber-300">
    <div class="container mx-auto px-6 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          <h4 class="text-lg font-semibold text-white mb-4">Stay Connected</h4>
          ...
          <div class="flex">
            <input
              ...
              class="bg-gray-700 text-white px-4 py-2 rounded-l focus:outline-none focus:ring-1 focus:ring-dark-gold-500 w-full" />
            <button
              class="bg-dark-gold-600 hover:bg-dark-gold-500 text-white px-4 py-2 rounded-r transition">
              Subscribe
            </button>
          </div>
